...
function getToken() {
    ...
    const tokenUri = 'https://westus.api.cognitive.microsoft.com/sts/v1.0/issueToken';
...
function t2s(accessToken, text){
    return new Promise(function (resolve, reject) {
        ...
        let request = https.request('https://westus.tts.speech.microsoft.com/cognitiveservices/v1', requestOptions, (res) => {
            if (res.statusCode !== 200){
